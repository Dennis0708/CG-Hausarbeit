...
void Application::createFeld() {
	...
	this->models.push_back(background);
	...
	for (int i = 0; i < LEBENSPUNKTE_SPIELER; i++) {
		...
		this->models.push_back(lebensPunkt);
	}
